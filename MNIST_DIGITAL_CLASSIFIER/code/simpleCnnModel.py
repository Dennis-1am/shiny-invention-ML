...
transform = transforms.Compose([
    transforms.RandomRotation(15),      # Tilt the image up to 15 degrees
    transforms.RandomAffine(0, translate=(0.1, 0.1)), # Shift it slightly
    transforms.ToTensor(),
...
torch.save(model.state_dict(), 'code/weights/mnist_cnn.pth')
